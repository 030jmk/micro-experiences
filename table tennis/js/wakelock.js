...
(function(PS) {
  ...
  document.addEventListener('visibilitychange', () => {
    if (document.visibilityState === 'visible' && PS._wakeLockActive) {
      request();
    }
  });

  PS._wakeLockActive = false;
  PS.wakeLock = {
    request: function() { PS._wakeLockActive = true; return request(); },
    release: function() { PS._wakeLockActive = false; return release(); }
  };
})(window.PongScore);
